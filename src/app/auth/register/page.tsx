      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <label
              className={`relative flex cursor-pointer flex-col items-center justify-center rounded-xl border p-4 transition-colors ${formData.role === 'citizen'
            ...
            <label
              className={`relative flex cursor-pointer flex-col items-center justify-center rounded-xl border p-4 transition-colors ${formData.role === 'officer'
                  ? 'border-orange-500 bg-orange-50 text-orange-900 dark:border-orange-500 dark:bg-orange-950/20 dark:text-orange-100'
                  : 'border-stone-200 bg-transparent text-stone-600 hover:bg-stone-50 dark:border-stone-800 dark:text-stone-400 dark:hover:bg-stone-900'
                }`}
            >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-stone-800 dark:focus:ring-offset-stone-950 ${errors.name ? 'border-red-500' : 'border-stone-200'
                }`}
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-stone-800 dark:focus:ring-offset-stone-950 ${errors.email ? 'border-red-500' : 'border-stone-200'
                }`}
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-stone-800 dark:focus:ring-offset-stone-950 ${errors.password ? 'border-red-500' : 'border-stone-200'
                }`}
              placeholder="••••••••"
            />
            ...
            {formData.role === 'officer' && (
              ...
              >
                ...
                <input
                  ...
                  className={`flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-stone-800 dark:focus:ring-offset-stone-950 ${errors.officerCode ? 'border-red-500' : 'border-stone-200'
                    }`}
