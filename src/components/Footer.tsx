...
export default function AppFooter() {
  ...
  // Hide footer on map page to maximize map viewport
  if (pathname === '/map') {
    return null;
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-1.5 mb-3 select-none">
              <span className="bg-primary text-white px-2 py-0.5 rounded-lg text-lg font-black">নাগরিক</span>
              <span className="text-xl font-bold tracking-tight text-stone-900 dark:text-white">Setu</span>
            </Link>
